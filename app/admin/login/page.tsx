          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-8 text-white focus:outline-none focus:border-[#c8a24a]/50 focus:bg-white/10 transition-all font-bold placeholder:text-white/20 shadow-inner disabled:opacity-60"
            ...
            <button
              type="submit"
              disabled={isBusy}
              className="w-full bg-[#c8a24a] text-black font-black uppercase tracking-[0.2em] py-5 rounded-3xl shadow-[0_15px_30px_rgba(212,175,55,0.3)] hover:brightness-110 hover:shadow-[#c8a24a]/40 disabled:opacity-50 transition-all flex items-center justify-center gap-3 active:scale-95 disabled:cursor-not-allowed"
            >
              {isBusy ? (
